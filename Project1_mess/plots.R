...
p1 <- ggplot(CLc.vec, aes(x = Year, y = resid)) +
  geom_point(alpha = 0.5) +
  geom_hline(aes(yintercept = 0), linetype = "dashed") +
  stat_summary(fun = mean, aes(group = 1), geom = "line", size = 1) +
  xlab("Year") +
  ylab("Std. Residual")
p2 <- ggplot(CLc.vec, aes(x = Length, y = resid)) +
  geom_point(alpha = 0.5) +
  geom_hline(aes(yintercept = 0), linetype = "dashed") +
  stat_summary(fun = mean, aes(group = 1), geom = "line", size = 1) +
  xlab("Length") +
  ylab("Std. Residual")
p3 <- ggplot(CLc.vec, aes(x = log(ECatch), y = resid)) +
  geom_point(alpha = 0.5) +
  geom_hline(aes(yintercept = 0), linetype = "dashed") +
...
p1 <- ggplot(FRVc.vec, aes(x = Year, y = resid)) +
  geom_point(alpha = 0.5) +
  geom_hline(aes(yintercept = 0), linetype = "dashed") +
  stat_summary(fun = mean, aes(group = 1), geom = "line", size = 1) +
  xlab("Year") +
  ylab("Std. Residual")
p2 <- ggplot(FRVc.vec, aes(x = Length, y = resid)) +
  geom_point(alpha = 0.5) +
  geom_hline(aes(yintercept = 0), linetype = "dashed") +
  stat_summary(fun = mean, aes(group = 1), geom = "line", size = 1) +
  xlab("Length") +
  ylab("Std. Residual")
p3 <- ggplot(FRVc.vec, aes(x = log(ECatch), y = resid)) +
  geom_point(alpha = 0.5) +
  geom_hline(aes(yintercept = 0), linetype = "dashed") +
  xlab("Log Expected Catch") +
  ylab("Std. Residual")
