...
jpeg(file=paste('fit_',u,'.jpeg',sep=''),width=8,height=8,units='in',res=600)
...

{
  ...
  jpeg(file="pop.jpeg",width=8,height=10,units='in',res=1200)
  ...
  #lines(tmb.data$year,biomass.L95,type='l',lty=2,lwd=2)
  #lines(tmb.data$year,biomass.U95,type='l',lty=2,lwd=2)
  ...
  #lines(tmb.data$year,exploit.L95,type='l',lty=2,lwd=2)
  #lines(tmb.data$year,exploit.U95,type='l',lty=2,lwd=2)
...

{
  ...
  jpeg(file="rpop.jpeg",width=8,height=10,units='in',res=1200)
...
{
  jpeg("catch.jpeg",width=10,height=8,units='in',res=1200)
...
{
  jpeg("pe.jpeg",width=8,height=8,units='in',res=1200)
...

{
  ...
  pnames = names(sd) 
  qname = paste('log_q',levels(tmb.data$name))
  ...
  jpeg(file="corr.jpeg",width=8,height=8,units='in',res=600)
...

{
  ...
  qname = paste('q',levels(factor(index.dat$name)))
  stdname = paste('std',levels(factor(index.dat$name)))
  ...
  tname = paste("Model results, nll = ",round(opt$objective,digits=2),sep="")    
