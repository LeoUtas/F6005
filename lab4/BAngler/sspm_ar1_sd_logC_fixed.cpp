...
Type objective_function<Type>::operator()()
{
  ...
  vector<Type> sd_log_index_vec = sd_log_index(iq);
  vector<Type> std_resid = resid / sd_log_index_vec;

  nll -= dnorm(resid, zero, sd_log_index_vec, true).sum();
