...
compile("fit_mess_sd_logC_fixed.cpp")

dyn.load("fit_mess_sd_logC_fixed")
# dyn.unload("fit_mess");
...
spm_ar1$gr(spm_ar1$par)

spm_ar1_fit <- nlminb(spm_ar1$par, spm_ar1$fn, spm_ar1$gr,
...
spm_ar1_fit$message
spm_ar1$gr(spm_ar1_fit$par)

report <- spm_ar1$report()

sd_report <- sdreport(spm_ar1)

spm_ar1$env$last.par.best
